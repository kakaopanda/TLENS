...
@Component
public class KafkaConsumer implements Serializable, ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws TimeoutException, StreamingQueryException {
        ...
        SparkConf conf = new SparkConf()
                ...
                .setMaster("spark://ec2-3-34-185-211.ap-northeast-2.compute.amazonaws.com:17077");

        Dataset<Row> df = SparkSession.builder()
                .appName(KafkaConstants.TOPIC_NAME)
                .master("spark://ec2-3-34-185-211.ap-northeast-2.compute.amazonaws.com:17077")
                .getOrCreate()
                .readStream()
                .format("kafka")
